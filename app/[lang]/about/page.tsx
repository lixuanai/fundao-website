...
const content: Record<Lang, {
  ...
  zh: {
    ...
    timeline: {
      title: '发展历程',
      items: [
        { year: '2023 Q1', title: '项目启动', desc: 'FunDAO 概念验证完成，核心智能合约开发启动' },
        { year: '2023 Q3', title: '合约审计', desc: '智能合约通过多家安全机构审计，代码开源' },
        { year: '2024 Q1', title: '主网上线', desc: 'FunDAO 协议在 BSC 主网部署，首批用户入驻' },
        { year: '2024 Q3', title: '生态扩展', desc: '合作伙伴突破 30+，覆盖全球 30 个国家和地区' },
        { year: '2025 Q2', title: 'V2 升级', desc: '协议 V2 版本上线，新增 AI 资产配置策略' },
      ],
    },
    values: {
      title: '核心价值观',
  ...
  en: {
    ...
    timeline: {
      title: 'Milestones',
      items: [
        { year: '2023 Q1', title: 'Project Launch', desc: 'FunDAO proof-of-concept completed, core smart contract development initiated' },
        { year: '2023 Q3', title: 'Contract Audit', desc: 'Smart contracts audited by multiple security firms, code open-sourced' },
        { year: '2024 Q1', title: 'Mainnet Launch', desc: 'FunDAO protocol deployed on BSC mainnet, first users onboarded' },
        { year: '2024 Q3', title: 'Ecosystem Expansion', desc: 'Partners exceeded 30+, covering 30 countries and regions globally' },
        { year: '2025 Q2', title: 'V2 Upgrade', desc: 'Protocol V2 launched with AI-driven asset allocation strategies' },
      ],
    },
    values: {
      title: 'Core Values',
